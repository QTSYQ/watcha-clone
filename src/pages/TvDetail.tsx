...
import useTvDetail from "../feartures/tv/useTvDetail";
import { AiOutlinePlayCircle, AiFillEye, AiOutlinePlus } from "react-icons/ai";
import { FaPen } from "react-icons/fa";
import { FiMoreHorizontal } from "react-icons/fi";
import { Rating } from "@mui/material";
import DefaultInfo from "../feartures/tv/detail/DefaultInfo";
import Similar from "../feartures/tv/detail/Similar";
...
function TvDetail() {
  ...
  const year = useMemo(
    () => data?.data.first_air_date.split("-")[0] || "",
    [data]
  );
            ...
            <TopInfo>
              <PosterContainer>
                <BackDrop>
                  <LeftBlur />
                  <BackdropImage
                    imageUrl={`${process.env.REACT_APP_API_IMAGE_PREFIX}/${data.data.backdrop_path}`}
                  >
                    <LeftGradient />
                    <RightGradient />
                  </BackdropImage>
              ...
              <Main>
                <Container>
                  <PosterWrapper>
                    <Poster
                      src={`${process.env.REACT_APP_API_IMAGE_PREFIX}/${data.data.poster_path}`}
                    />
                  </PosterWrapper>
                  <ContainerWrapper>
